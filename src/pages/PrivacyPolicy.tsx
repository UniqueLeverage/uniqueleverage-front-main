        ...
        <div className="container mx-auto px-4">
            <div className="revert-all-content-styles">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Application</strong> refers to Unique Leverage, the software program provided by the
                            Company.
                        </p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                            Agreement)
                            refers to Unique Leverage LLC, 7148 Osage Allen Park, Michigan.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Unique Leverage, accessible from <a
                            href="https://uniqueleverage.com"
                            rel="external nofollow noopener"
                            target="_blank">uniqueleverage.com</a>
                        </p>
                    </li>
                    <li>
                ...
                <p>If You decide to register through or otherwise grant us access to a Third-Party Social Media Service,
                    ...
                    account,
                    such
                    as Your name, Your email address, Your activities or Your contact list associated with that
                    account.</p>
                ...
                <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer
                    ...
                    browser.
                    You can learn more about cookies on <a
                ...
                <p>Your information, including Personal Data, is processed at the Company's operating offices and in any
                    ...
                    be
                    transferred to â€” and maintained on â€” computers located outside of Your state, province, country
                    or
                    other
                ...
                <p>You may update, amend, or delete Your information at any time by signing in to Your Account, if you
                    have
                    one,
                    and visiting the account settings section that allows you to manage Your personal information. You
                    may
                    also
                    contact Us to request access to, correct, or delete any personal information that You have provided
                    to
                    Us.</p>
                ...
                <p>
                    By subscribing to text messages from Unique Leverage, LLC, you agree to receive recurring automated
                    messages. Message and data rates may apply depending on your carrier. Message frequency varies. You
                    may opt out at any time by replying with "STOP" or "UNSUBSCRIBE." For assistance, reply "HELP" or
                    "INFO" or contact us directly at <a href="tel:+13132172212">+1 313 217 2212</a> or at <a href="mailto:admin@uniqueleverage.com">admin@uniqueleverage.com</a>.
                </p>
                <p>
                    We value your privacy and are committed to protecting your information. The data collected for text
                    message subscriptions, including phone numbers and any responses, will only be used to provide the
                    services you requested and improve your experience. For more information, please see our detailed
                ...
                <ul>
                    <li>
                        <p>By email: admin@uniqueleverage.com</p>
                    </li>
                    <li>
                        <p>By phone number: 3132172212</p>
                    </li>
                </ul>
            </div>
        </div>
