const TermsOfService = () => {
    return (
        <div className="container mx-auto px-4">
            <div className="revert-all-content-styles">
                <h1>Terms of Service</h1>
                <p>Last Updated: January 28, 2025</p>
                <h2>AGREEMENT TO OUR LEGAL TERMS</h2>
                <p>We are Unique Leverage, LLC ("Company," "we," "us," "our"), a company registered in Michigan, United
                    States at 7148 Osage, Allen Park, MI 48101.</p>
                <p>We operate the website <a href="https://www.uniqueleverage.com">www.uniqueleverage.com</a> (the
                    "Site"), the mobile application Unique Leverage (the "App"), as well as any other related products
                    and services that refer or link to these legal terms (the "Legal Terms") (collectively, the
                    "Services").</p>
                <p>Software & Marketing</p>
                <p>You can contact us by phone at 3132172212, email at admin@uniqueleverage.com, or by mail to 7148
                    Osage, Allen Park, MI 48101, United States.</p>
                <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on
                    behalf of an entity ("you"), and Unique Leverage, LLC, concerning your access to and use of the
                ...
                <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The
                    modified Legal Terms will become effective upon posting or notifying you by
                    admin@uniqueleverage.com, as stated in the email message. By continuing to use the Services after
                    the effective date of any changes, you agree to be bound by the modified terms.</p>
                <div>
                    <div>The Services are intended for users who are at least 18 years old. Persons under
                    ...
                    <div className="mb-2"><a href="#services">1. OUR SERVICES</a></div>
                    <div className="mb-2"><a href="#ip">2. INTELLECTUAL PROPERTY RIGHTS</a></div>
                    <div className="mb-2"><a href="#userreps">3. USER REPRESENTATIONS</a></div>
                    <div className="mb-2"><a href="#userreg">4. USER REGISTRATION</a></div>
                    <div className="mb-2"><a href="#purchases">5. PURCHASES AND PAYMENT</a></div>
                    <div className="mb-2"><a href="#subscriptions">6. SUBSCRIPTIONS</a></div>
                    <div className="mb-2"><a href="#software">7. SOFTWARE</a></div>
                    <div className="mb-2"><a href="#prohibited">8. PROHIBITED ACTIVITIES</a></div>
                    <div className="mb-2"><a href="#ugc">9. USER GENERATED CONTRIBUTIONS</a></div>
                    <div className="mb-2"><a href="#license">10. CONTRIBUTION LICENSE</a></div>
                    <div className="mb-2"><a href="#mobile">11. MOBILE APPLICATION LICENSE</a></div>
                    <div className="mb-2"><a href="#socialmedia">12. SOCIAL MEDIA</a></div>
                    <div className="mb-2"><a href="#thirdparty">13. THIRD-PARTY WEBSITES AND CONTENT</a></div>
                    <div className="mb-2"><a href="#sitemanage">14. SERVICES MANAGEMENT</a></div>
                    <div className="mb-2"><a href="#ppyes">15. PRIVACY POLICY</a></div>
                    <div className="mb-2"><a href="#dmca">16. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND
                        POLICY</a>
                    </div>
                    <div className="mb-2"><a href="#terms">17. TERM AND TERMINATION</a></div>
                    <div className="mb-2"><a href="#modifications">18. MODIFICATIONS AND INTERRUPTIONS</a></div>
                    <div className="mb-2"><a href="#law">19. GOVERNING LAW</a></div>
                    <div className="mb-2"><a href="#disputes">20. DISPUTE RESOLUTION</a></div>
                    <div className="mb-2"><a href="#corrections">21. CORRECTIONS</a></div>
                    <div className="mb-2"><a href="#disclaimer">22. DISCLAIMER</a></div>
                    <div className="mb-2"><a href="#liability">23. LIMITATIONS OF LIABILITY</a></div>
                    <div className="mb-2"><a href="#indemnification">24. INDEMNIFICATION</a></div>
                    <div className="mb-2"><a href="#userdata">25. USER DATA</a></div>
                    <div className="mb-2"><a href="#electronic">26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND
                        SIGNATURES</a>
                    </div>
                    <div className="mb-2"><a href="#sms">27. SMS TEXT MESSAGING</a></div>
                    <div className="mb-2"><a href="#california">28. CALIFORNIA USERS AND RESIDENTS</a></div>
                    <div className="mb-2"><a href="#misc">29. MISCELLANEOUS</a></div>
                    <div className="mb-2"><a href="#contact">30. CONTACT US</a></div>
                </div>
                <div>
                    <div id="services">
                        <h2>1. OUR SERVICES</h2>
                    </div>
                    <div>The information provided when using the Services is not intended for distribution
                        to or use by any person or entity in any jurisdiction or country where such distribution or use
                        would be
                    ...
                    <div>The Services are not tailored to comply with industry-specific regulations
                ...
                <div>
                    ...
                    <div>We are the owner or the licensee of all intellectual property rights in our
                    ...
                    <div>Our Content and Marks are protected by copyright and trademark laws (and various
                        other intellectual property rights and unfair competition laws) and treaties in the United
                        States and around the
                        world.
                    </div>
                    <div>The Content and Marks are provided in or through the Services "AS IS" for your
                        internal business purpose only.
                    </div>
                    <div>
                        <h3>Your use of our Services</h3>
                    </div>
                    <div>Subject to your compliance with these Legal Terms, including the "<a
                        href="#prohibited">PROHIBITED ACTIVITIES</a>" section below, we grant you a
                    ...
                    <div>solely for your internal business purpose.</div>
                    <div>Except as set out in this section or elsewhere in our Legal Terms, no part of the
                    ...
                    <div>If you wish to make any use of the Services, Content, or Marks other than as set
                        out in this section or elsewhere in our Legal Terms, please address your request to:
                        admin@uniqueleverage.com.
                ...
                <div>
                    <div>We reserve all rights not expressly granted to you in and to the Services,
                        Content, and Marks.
                    </div>
                    <div>Any breach of these Intellectual Property Rights will constitute a material
                    ...
                    <div>Please review this section and the "<a href="#prohibited"
                    >PROHIBITED
                        ACTIVITIES</a>" section carefully prior to using our Services to understand the (a) rights you
                        give us and (b)
                        obligations you have when you post or upload any content through the Services.
                    </div>
                    <div><strong>Submissions:</strong> By directly sending us any question, comment,
                        suggestion, idea, feedback, or other information about the Services ("Submissions"), you agree
                        to assign to us
                    ...
                    <div><strong>Contributions:</strong> The Services may invite you to chat, contribute
                        ...
                        or through the
                        Services, including but not limited to text, writings, video, audio, photographs, music,
                        graphics, comments,
                    ...
                    <div>You understand that Contributions may be viewable by other users of the Services
                        and possibly through third-party websites.
                    </div>
                    <div><strong>When you post Contributions, you grant us a license (including use of
                        your name, trademarks, and logos):&nbsp;</strong>By posting any Contributions, you grant us an
                        unrestricted,
                        unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid,
                        worldwide right, and
                        license to: use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store,
                        publicly
                        ...
                        advertising, or
                        otherwise, to prepare derivative works of, or incorporate into other works, your Contributions,
                        and to
                        sublicense the licenses granted in this section. Our use and distribution may occur in any media
                        formats and
                        through any media channels.
                    </div>
                    <div>This license includes our use of your name, company name, and franchise name, as
                        applicable, and any of the trademarks, service marks, trade names, logos, and personal and
                        commercial images you
                        provide.
                    </div>
                    <div><strong>You are responsible for what you post or upload:</strong> By sending us
                    ...
                    <ul>
                        ...
                        >PROHIBITED
                            ACTIVITIES</a>" and will not post, send, publish, upload, or transmit through the Services
                            any Submission
                        ...
                        <li>warrant that any such Submission and/or Contributions are original to you or
                            that you have the necessary rights and licenses to submit such Submissions and/or
                            Contributions and that you
                    ...
                    <div>You are solely responsible for your Submissions and/or Contributions and you
                        expressly agree to reimburse us for any and all losses that we may suffer because of your breach
                        of (a) this
                        section, (b) any third party&rsquo;s intellectual property rights, or (c) applicable law.
                    </div>
                    <div><strong>We may remove or edit your Content:</strong> Although we have no
                        obligation to monitor any Contributions, we shall have the right to remove or edit any
                    ...
                    <div>We respect the intellectual property rights of others. If you believe that any
                        material available on or through the Services infringes upon any copyright you own or control,
                        please
                        immediately refer to the " <a href="#dmca">DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA)
                            NOTICE AND POLICY </a> " section below.
                    </div>
                </div>
                <div>
                    <div id="userreps">
                ...
                <div>
                    <div>By using the Services, you represent and warrant that: (1) all registration
                        ...
                        legal capacity and
                        you agree to comply with these Legal Terms; (4) you are not a minor in the jurisdiction in which
                        you reside; (5)
                        you will not access the Services through automated or non-human means, whether through a bot,
                        script or
                        otherwise; (6) you will not use the Services for any illegal or unauthorized purpose; and (7)
                        your use of the
                ...
                <div>
                    <div>
                        <div>
                            <div>If you provide any information that is untrue, inaccurate, not current,
                        ...
                        <div>
                            <div>You may be required to register to use the Services. You agree to keep
                ...
                <div>
                    ...
                    <div>- Apple Pay</div>
                    <div>- Check</div>
                    <div>You agree to provide current, complete, and accurate purchase and account
                ...
                <div>
                    <div>You agree to pay all charges at the prices then in effect for your purchases and
                        any applicable shipping fees, and you authorize us to charge your chosen payment provider for
                        any such amounts
                ...
                <div>
                    <div>We reserve the right to refuse any order placed through the Services. We may, in
                        our sole discretion, limit or cancel quantities purchased per person, per household, or per
                        order. These
                    ...
                    <div>Your subscription will continue and automatically renew unless canceled. You
                        ...
                        cycle will
                        depend on the type of subscription plan you choose when you subscribed to the Services.
                    </div>
                    <div>
                        <h3>Cancellation</h3>
                    </div>
                    <div>You can cancel your subscription by contacting customer support via email or
                        text. We do not require a 30 day notice. Your cancellation will take effect at the end of the
                        current paid term.
                        If you have any questions or are unsatisfied with our Services, please email us at
                        admin@uniqueleverage.com .
                    </div>
                    <div>
                        <h3>Fee Changes</h3>
                    ...
                    <div>We may include software for use in connection with our Services. If such software
                        is accompanied by an end user license agreement ("EULA"), the terms of the EULA will govern your
                        use of the
                        software. If such software is not accompanied by a EULA, then we grant to you a non-exclusive,
                        revocable,
                        personal, and non-transferable license to use such software solely in connection with our
                        services and in
                        ...
                        risk arising out
                        of use or performance of any software. You may not reproduce or redistribute any software except
                        in accordance
                    ...
                    <div>
                        <div>You may not access or use the Services for any purpose other than that for
                            which we make the Services available. The Services may not be used in connection with any
                            commercial
                    ...
                    <div>
                        <div>
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>Trick, defraud, or mislead us and other users, especially in any
                                        attempt to learn sensitive account information such as user passwords.
                                    </li>
                                    <li>Circumvent, disable, or otherwise interfere with security-related
                                        features of the Services, including features that prevent or restrict the use or
                                        copying of any
                                        Content or enforce limitations on the use of the Services and/or the Content
                                        contained therein.
                                    </li>
                                    <li>Disparage, tarnish, or otherwise harm, in our opinion, us and/or
                                        the Services.
                                    </li>
                                    <li>Use any information obtained from the Services in order to harass,
                                        abuse, or harm another person.
                                    </li>
                                    <li>Make improper use of our support services or submit false reports
                                        of abuse or misconduct.
                                    </li>
                                    <li>Use the Services in a manner inconsistent with any applicable laws
                                        or regulations.
                                    </li>
                                    ...
                                    <li>Engage in any automated use of the system, such as using scripts
                                    ...
                                    <li>Attempt to impersonate another user or person or use the username
                                        of another user.
                                    </li>
                                    <li>Upload or transmit (or attempt to upload or to transmit) any
                                    ...
                                    <li>Interfere with, disrupt, or create an undue burden on the Services
                                    ...
                                    <li>Use the Services as part of any effort to compete with us or
                                ...
                                <div>The Services may invite you to chat, contribute to, or participate in
                                    blogs, message boards, online forums, and other functionality, and may provide you
                                    with the
                        ...
                        <div>
                            <ul>
                                ...
                                <li>You are the creator and owner of or have the necessary licenses,
                                ...
                                <li>You have the written consent, release, and/or permission of each and
                                ...
                                <li>Your Contributions do not ridicule, mock, disparage, intimidate, or
                                    abuse anyone.
                                </li>
                                <li>Your Contributions are not used to harass or threaten (in the legal
                                    sense of those terms) any other person and to promote violence against a specific
                                    person or class of
                                    people.
                                </li>
                                <li>Your Contributions do not violate any applicable law, regulation, or
                                    rule.
                                </li>
                                <li>Your Contributions do not violate the privacy or publicity rights of
                                    any third party.
                                </li>
                                ...
                                <li>Your Contributions do not include any offensive comments that are
                                ...
                                <li>Your Contributions do not otherwise violate, or link to material that
                                    violates, any provision of these Legal Terms, or any applicable law or regulation.
                                </li>
                            </ul>
                            <div>Any use of the Services in violation of the foregoing violates these
                                Legal Terms and may result in, among other things, termination or suspension of your
                                rights to use the
                                Services.
                            </div>
                        </div>
                    ...
                    <div>
                        <div>By posting your Contributions to any part of the Services&nbsp;or making
                            Contributions accessible to the Services by linking your account from the Services to any of
                            your social
                    ...
                    <div>
                        <div>This license will apply to any form, media, or technology now known or
                    ...
                    <div>
                        <div>We do not assert any ownership over your Contributions. You retain full
                            ...
                            your Contributions
                            to the Services and you expressly agree to exonerate us from any and all responsibility and
                            to refrain from
                            any legal action against us regarding your Contributions.
                        </div>
                    </div>
                    <div>
                        <div>We have the right, in our sole and absolute discretion, (1) to edit, redact,
                            or otherwise change any Contributions; (2) to re-categorize any Contributions to place them
                            in more
                ...
                <div>
                    ...
                    <div>If you access the Services via the App, then we grant you a revocable,
                        non-exclusive, non-transferable, limited right to install and use the App on wireless electronic
                        devices owned
                        or controlled by you, and to access and use the App on such devices strictly in accordance with
                        the terms and
                        conditions of this mobile application license contained in these Legal Terms. You shall not: (1)
                        except as
                        ...
                        your access or use
                        of the App; (4) remove, alter, or obscure any proprietary notice (including any notice of
                        copyright or
                        ...
                        send any
                        unsolicited commercial email; or (9) use any proprietary information or any of our interfaces or
                        our other
                    ...
                    <div>The following terms apply when you use the App obtained from either the Apple
                        ...
                        the applicable App
                        Distributor&rsquo;s terms of service; (2) we are responsible for providing any maintenance and
                        support services
                        ...
                        no other warranty obligation whatsoever with respect to the App; (4) you represent and warrant
                        that (i) you are
                        not located in a country that is subject to a US government embargo, or that has been designated
                        by the US
                        government as a "terrorist supporting" country and (ii) you are not listed on any US government
                        list of
                        prohibited or restricted parties; (5) you must comply with applicable third-party terms of
                        agreement when using
                        the App, e.g., if you have a VoIP application, then you must not be in violation of their
                    ...
                    <div>
                        <div>As part of the functionality of the Services, you may link your account with
                            online accounts you have with third-party service providers (each such account, a
                            "Third-Party Account") by
                            either: (1) providing your Third-Party Account login information through the Services; or
                            (2) allowing us to
                            ...
                            you understand that (1) we may access, make available, and store (if applicable) any content
                            that you have
                            provided to and stored in your Third-Party Account (the "Social Network Content") so that it
                            is available on
                            and through the Services via your account, including without limitation any friend lists and
                            (2) we may
                            ...
                            Network Content
                            may no longer be available on and through the Services. You will have the ability to disable
                            the connection
                            ...
                            non-infringement,
                            and we are not responsible for any Social Network Content. You acknowledge and agree that we
                            may access your
                            email address book associated with a Third-Party Account and your contacts list stored on
                            your mobile device
                    ...
                    <div>The Services may contain (or you may be sent via the Site or App) links to other
                        ...
                        Third-Party&nbsp;Content
                        does not imply approval or endorsement thereof by us. If you decide to leave the Services and
                        access the
                        ...
                        including privacy
                        and data gathering practices, of any website to which you navigate from the Services or relating
                        to any
                    ...
                    <div>We reserve the right, but not the obligation, to: (1) monitor the Services for
                        violations of these Legal Terms; (2) take appropriate legal action against anyone who, in our
                        sole discretion,
                    ...
                    <div>We care about data privacy and security. Please review our Privacy
                        Policy:<strong>&nbsp;uniqueleverage.com/privacy-policy</strong>. By using the Services, you
                        agree to be bound by
                        our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services
                        are hosted in
                        the United States. If you access the Services from any other region of the world with laws or
                        other requirements
                    ...
                    <div id="dmca">
                        <h2>16. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</h2>
                    </div>
                    <div>
                        <h3>Notifications</h3>
                    </div>
                    <div>We respect the intellectual property rights of others. If you believe that any
                        material available on or through the Services infringes upon any copyright you own or control,
                        please
                        immediately notify our Designated Copyright Agent using the contact information provided below
                        (a
                        ...
                        liable for damages
                        if you make material misrepresentations in a Notification. Thus, if you are not sure that
                        material located on or
                        linked to by the Services infringes your copyright, you should consider first contacting an
                        attorney.
                    </div>
                    <div>All Notifications should meet the requirements of DMCA 17 U.S.C. &sect; 512(c)(3)
                        and include the following information: (1) A physical or electronic signature of a person
                        authorized to act on
                        behalf of the owner of an exclusive right that is allegedly infringed; (2) identification of the
                        copyrighted
                        work claimed to have been infringed, or, if multiple copyrighted works on the Services are
                        covered by the
                        Notification, a representative list of such works on the Services; (3) identification of the
                        material that is
                        claimed to be infringing or to be the subject of infringing activity and that is to be removed
                        or access to
                        which is to be disabled, and information reasonably sufficient to permit us to locate the
                        material; (4)
                        information reasonably sufficient to permit us to contact the complaining party, such as an
                        address, telephone
                        number, and, if available, an email address at which the complaining party may be contacted; (5)
                        a statement
                        that the complaining party has a good faith belief that use of the material in the manner
                        complained of is not
                        authorized by the copyright owner, its agent, or the law; and (6) a statement that the
                        information in the
                ...
                <div>
                    ...
                    <div>If you believe your own copyrighted material has been removed from the Services
                        ...
                        Federal District
                        Court in which your address is located, or if your address is outside the United States, for any
                        judicial
                        district in which we are located; (3) a statement that you will accept service of process from
                        the party that
                        filed the Notification or the party's agent; (4) your name, address, and telephone number; (5) a
                        statement under
                        penalty of perjury that you have a good faith belief that the material in question was removed
                        or disabled as a
                        result of a mistake or misidentification of the material to be removed or disabled; and (6) your
                        physical or
                        electronic signature.
                    </div>
                    <div>If you send us a valid, written Counter Notification meeting the requirements
                        described above, we will restore your removed or disabled material, unless we first receive
                        notice from the
                        party filing the Notification informing us that such party has filed a court action to restrain
                        you from
                ...
                <div>
                    <div>
                        <div>Nathan Allison</div>
                        <div>Attn: Copyright Agent</div>
                        <div>7148 Osage</div>
                        <div>Allen Park, MI 48101</div>
                        <div>United States</div>
                        <div>admin@uniqueleverage.com</div>
                        <div id="terms">
                            <h2>17. TERM AND TERMINATION</h2>
                        </div>
                        <div>These Legal Terms shall remain in full force and effect while you use the
                            Services. WITHOUT LIMITING ANY OTHER PROVISION OF THESE LEGAL TERMS, WE RESERVE THE RIGHT
                            TO, IN OUR SOLE
                            ...
                            APPLICABLE LAW
                            OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICES OR DELETE YOUR
                            ACCOUNT AND&nbsp;ANY
                        ...
                        <div>We reserve the right to change, modify, or remove the contents of the
                            Services at any time or for any reason at our sole discretion without notice. However, we
                            have no obligation
                            to update any information on our Services. We will not be liable to you or any third party
                            for any
                            modification, price change, suspension, or discontinuance of the Services.
                        </div>
                        <div>We cannot guarantee the Services will be available at all times. We may
                        ...
                        <div>These Legal Terms and your use of the Services are governed by and construed
                            in accordance with the laws of the State of Michigan applicable to agreements made and to be
                            entirely
                            performed within&nbsp;the State of Michigan,&nbsp;without regard to its conflict of law
                            principles.
                        </div>
                        <div id="disputes">
                        ...
                        <div>To expedite resolution and control the cost of any dispute, controversy, or
                            claim related to these Legal Terms (each a "Dispute" and collectively, the "Disputes")
                        ...
                        <div>If the Parties are unable to resolve a Dispute through informal negotiations,
                            the Dispute (except those Disputes expressly excluded below) will be finally and exclusively
                            resolved by
                            ...
                            at the <a
                                href="http://www.adr.org" target="_blank" rel="noopener noreferrer">American
                                Arbitration Association (AAA) website</a>. Your arbitration fees and your share of
                            arbitrator
                            compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by
                            the AAA Consumer
                            Rules. If such costs are determined by the arbitrator to be excessive, we will pay all
                            ...
                            applicable law,
                            the arbitration will take place in United States, Michigan. Except as otherwise provided
                            herein, the Parties
                        ...
                        <div>If for any reason, a Dispute proceeds in court rather than arbitration, the
                            Dispute shall be commenced or prosecuted in the &nbsp;state and federal courts &nbsp;located
                            in Wayne ,
                            Michigan , and the Parties hereby consent to, and waive all defenses of lack of personal
                            jurisdiction, and
                        ...
                        <div>In no event shall any Dispute brought by either Party related in any way to
                            the Services be commenced more than one (1) years after the cause of action arose. If this
                            provision is
                        ...
                        <div>The Parties agree that any arbitration shall be limited to the Dispute
                            between the Parties individually. To the full extent permitted by law, (a) no arbitration
                            shall be joined
                        ...
                        <div>The Parties agree that the following Disputes are not subject to the above
                            provisions concerning informal negotiations binding arbitration: (a) any Disputes seeking to
                            enforce or
                            ...
                            any claim for injunctive relief. If this provision is found to be illegal or unenforceable,
                            then neither
                        ...
                        <div>There may be information on the Services that contains typographical errors,
                        ...
                        <div>THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT
                            YOUR USE OF THE SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW,
                            WE DISCLAIM ALL
                            ...
                            YOUR ACCESS TO
                            AND USE OF THE SERVICES, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR
                            ANY AND ALL
                        ...
                        <div>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD
                            PARTY FOR ANY
                            ...
                            ALL TIMES BE
                            LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US&nbsp;DURING THE three (3) mONTH PERIOD
                            PRIOR TO ANY CAUSE
                        ...
                        <div>You agree to defend, indemnify, and hold us harmless, including our
                            ...
                            expenses, made by any third party due to or arising out of: (1) your Contributions;&nbsp;(2)
                            use of the
                            Services; (3) breach of these Legal Terms; (4) any breach of your representations and
                            warranties set forth
                            in these Legal Terms; (5) your violation of the rights of a third party, including but not
                            limited to
                        ...
                        <div>We will maintain certain data that you transmit to the Services for the
                            purpose of managing the performance of the Services, as well as data relating to your use of
                            the Services.
                        ...
                        <div>Visiting the Services, sending us emails, and completing online forms
                            constitute electronic communications. You consent to receive electronic communications, and
                            you agree that
                            all agreements, notices, disclosures, and other communications we provide to you
                            electronically, via email
                            and on the Services, satisfy any legal requirement that such communication be in writing.
                            YOU HEREBY AGREE
                        ...
                        <div id="sms">
                            <h2>27. SMS TEXT MESSAGING</h2>
                        </div>
                        <div>
                            <h3>Message Frequency</h3>
                        </div>
                        <div>We only use messaging to contact internal customers for customer support, no
                            marketing efforts.
                        </div>
                        <div>
                            <h3>Opting Out</h3>
                        </div>
                        <div>If at any time you wish to stop receiving SMS messages from us, simply reply
                            to the text with "STOP.&rdquo; You may receive an SMS message confirming your opt out.
                        </div>
                        <div>
                            <h3>Message and Data Rates</h3>
                        </div>
                        <div>Please be aware that message and data rates may apply to any SMS messages
                        ...
                        <div>If you have any questions or need assistance regarding our SMS
                            communications, please email us at admin@uniqueleverage.com or call at 3132172212.<br/>
                        </div>
                        <div id="california">
                            <h2>28. CALIFORNIA USERS AND RESIDENTS</h2>
                        </div>
                        <div>If any complaint with us is not satisfactorily resolved, you can contact the
                        ...
                        <div>These Legal Terms and any policies or operating rules posted by us on the
                            Services or in respect to the Services constitute the entire agreement and understanding
                            between you and us.
                        ...
                        <div>In order to resolve a complaint regarding the Services or to receive further
                            information regarding use of the Services, please contact us at:
                        </div>
                        <h3>Opt-In and Opt-Out</h3>
                        <ul>
                            <li style={{marginBottom: '15px'}}>
                                <strong>1. Opt-In:</strong> By replying with keywords such as "JOIN" or "SUBSCRIBE," you
                                are consenting to receive recurring text messages from Unique Leverage, LLC. Message
                                frequency may vary based on promotional offers or updates.
                            </li>
                            <li>
                                <strong>2. Opt-Out:</strong> To stop receiving messages, reply with "STOP" or
                                "UNSUBSCRIBE." Once opted out, you will no longer receive messages unless you opt back
                                in by replying "SUBSCRIBE" or "JOIN."
                            </li>
                        </ul>

                        <h3>Help and Support</h3>
                        <p>If you require assistance, you may reply with "HELP" or "INFO" to receive support details.
                            You can also contact us directly at:</p>
                        <ul>
                            <li style={{marginBottom: '10px'}}><strong>Phone:</strong> <a href="tel:+13132172212">+1 313 217 2212</a></li>
                            <li><strong>Email:</strong> <a
                                href="mailto:admin@uniqueleverage.com">admin@uniqueleverage.com</a></li>
                        </ul>

                        <h3>Message and Data Rates</h3>
                        <p>Message and data rates may apply. These charges depend on your carrier and subscription
                            plan.</p>

                        <h3>Disclaimers</h3>
                        <p>Unique Leverage, LLC is not responsible for delays or failures in the delivery of text
                            messages caused by factors beyond our control, such as network outages or carrier service
                            disruptions.</p>
                        <div><strong>Unique Leverage, LLC</strong></div>
                        <div><strong>7148 Osage</strong></div>
                        <div><strong>Allen Park, MI 48101</strong></div>
                        <div><strong>United States</strong></div>
                        <div><strong><strong>Phone: 3132172212</strong></strong></div>
                        <div><strong><strong>admin@uniqueleverage.com</strong></strong></div>
                    </div>
                </div>
            </div>
        </div>
